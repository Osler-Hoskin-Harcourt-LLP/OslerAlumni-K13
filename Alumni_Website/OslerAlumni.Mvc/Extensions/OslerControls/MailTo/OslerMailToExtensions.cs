    ...
    public static class OslerMailToExtensionsExtensions
    {
        ...
        public class OslerMailToBuilder
        {
            ...
            public OslerMailToBuilder(HtmlHelper html)
            {
                ...
                _anchor.InnerHtml = $"<span class='show-for-sr'>{ResHelper.GetString(Core.Definitions.Constants.ResourceStrings.ScreenReader.ShareThisPage)}</span>";
            }
            ...
            public MvcHtmlString ToHtmlString()
            {
                ...
                return MvcHtmlString.Create(_anchor.ToString());
            }
