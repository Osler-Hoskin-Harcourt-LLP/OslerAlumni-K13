...
namespace OslerAlumni.Mvc.Extensions
{
    public static partial class OslerHtmlHelperExtensions
    {
        ...
        /// </remarks>
        public static MvcHtmlString StyledEditorFor<TModel, TValue>(
            this HtmlHelper<TModel> html,
            Expression<Func<TModel, TValue>> expression,
            MvcHtmlString labelMarkup = null,
            MvcHtmlString editorMarkup = null,
        ...
        /// @Html.StyledEditorFor(model => model.Message, Html.TextAreaFor(model => model.Message))
        /// </remarks>
        public static MvcHtmlString StyledCheckboxFor<TModel>(
            this HtmlHelper<TModel> html,
        ...
        public static MvcHtmlString StyledFileUploaderFor<TModel, TValue>(
            this HtmlHelper<TModel> html,
            Expression<Func<TModel, TValue>> expression,
            MvcHtmlString labelMarkup = null,
            object htmlAttributes = null,
        ...
        public static MvcHtmlString StyledRadioButtonListFor<TModel, TEnum>(
            this HtmlHelper<TModel> html,
            ...
            where TEnum : struct, IConvertible
        {
            ...
            return html.Partial("_StyledRadioButtonListFor", new ViewDataDictionary()
            {
        ...
        public static MvcHtmlString StyledEnumDropDownListFor<TModel, TValue>(
            this HtmlHelper<TModel> html,
            Expression<Func<TModel, TValue>> expression, Enum options)
        {
            ...
            return html.Partial("_StyledEnumDropDownListFor", new ViewDataDictionary()
            {
                {"DivId", $"{elementId}_{Guid.NewGuid()}" },
        ...
        public static MvcHtmlString GoogleCaptchaFor<TModel, TValue>(
            this HtmlHelper<TModel> html,
            Expression<Func<TModel, TValue>> expression)
        {
        ...
        /// <returns></returns>
        public static MvcHtmlString FormErrorSummary(
        ...
        private static MvcHtmlString GetStyledEditor<TModel, TValue>(
            ...
            string viewName = "_StyledEditorFor")
        {
            ...
            viewData.Add("ExplanationText", html.LocalizedDescriptionFor(expression));
