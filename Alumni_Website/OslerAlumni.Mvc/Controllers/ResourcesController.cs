        ...
        : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            if (featuredResource != null)
            {
                ...
                if (featuredResource.HideFromCompetitors && _authorizationService.CurrentUserHasCompetitorRole())
                {
        ...
        public ActionResult Details()
        {
            ...
            if (page.HideFromCompetitors && _authorizationService.CurrentUserHasCompetitorRole())
            {
                return HttpNotFound();
            }
