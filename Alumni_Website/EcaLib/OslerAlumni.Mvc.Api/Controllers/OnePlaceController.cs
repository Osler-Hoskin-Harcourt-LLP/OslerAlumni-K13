...
namespace OslerAlumni.Mvc.Api.Controllers
{
        ...
        : BaseApiController
    {
        ...
        [HttpPost]
        public IHttpActionResult FunctionAttendeesMock(
        ...
        [HttpPost]
        [ResponseType(typeof(SearchResponse<Attendee>))]
        public IHttpActionResult FunctionAttendees(
            [FromBody] FunctionAttendeeSearchRequest searchRequest)
        {
            if (searchRequest == null)
            {
        ...
        private IHttpActionResult ToSearchResponse<T>(string culture, List<T> returnList)
        {
