...
namespace OslerAlumni.Mvc.Extensions.OslerControls.RichTextField.Models.Helpers
{
    public class InlineWidgetResolver
    {
        ...
        public string ToResolvedWidgetContent<TModel>(string content, IHtmlHelper<TModel> htmlHelperObject)
        {
            ...
            {
                var temp = w;
                ParseAndSetWidgetAttributes(ref temp);
            ...
            {
                var temp = block;
               ReplaceWidgetsWithMarkup(ref temp, htmlHelperObject);
            }
        ...
        private void ReplaceWidgetsWithMarkup<TModel>(ref IElement node, IHtmlHelper<TModel> htmlHelperObject)
        {
