...
namespace OslerAlumni.Mvc.Extensions.OslerControls.Image
{
    public static class OslerImageExtensions
    {
        ...
        public class OslerImageBuilder
        {
            ...
            public OslerImageBuilder(IHtmlHelper html, MediaFileInfo mediaFile)
            {
                _html = html;
            ...
            public OslerImageBuilder(IHtmlHelper html, string relativePath)
            {
                _html = html;
            ...
            {
                var urlHelper = new UrlHelper(_html.ViewContext);
