...
namespace OslerAlumni.Core.Services
{
        ...
        : ServiceBase, IAzureScoringProfileService
    {
        ...
        public void AddScoringProfileToAzureIndex(Index index, string profileName, Dictionary<string,double> scoringWeights, ScoringFunctionAggregation type = ScoringFunctionAggregation.Sum)
        {
